...
<body>
  ...
  <h1 class="text-center mt-5 mb-5">Edition de la tache</h1>
...
<form method="post" action="{{route('task.update', ['task'=>$task->id])}}">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="texte" name="name" class="form-control" id="nameTask" value="{{ $task->name }}">
    </div>
  </div>
  <div class="row mb-3">
    <label for="descriptionTask" class="col-sm-2 col-form-label">Description</label>
    <div class="col-sm-10">
      <input type="texte" name="description" class="form-control" id="descriptionTask" value="{{ $task->description}}">
    </div>
  </div>
  <div class="row mb-3">
  ...
  <button type="submit" class="btn btn-primary">Modifier cette tache</button>
</form>
